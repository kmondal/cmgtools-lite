pairs={
    'sump4(0, genLepZ1_pt,genLepZ1_eta,genLepZ1_phi,genLepZ1_mass,genLepZ2_pt,genLepZ2_eta,genLepZ2_phi,genLepZ2_mass):sump4(0,LepZ1_pt,LepZ1_eta,LepZ1_phi,LepZ1_mass,LepZ2_pt,LepZ2_eta,LepZ2_phi,LepZ2_mass)' : ['[0,5,10,15,20,25,30,40,50,60,70,80,90,100,110,120,130,140,160,180,200,250,300]*[0,10,20,30,50,70,90,110,130,160,200,300]','Reco p\_\{T\}(Z) [GeV]','Gen p\_\{T\}(Z) [GeV]'],
    'LeadJet_mcPt:LeadJet_pt' : ['[25,30,35,40,50,60,70,80,90,100,110,120,130,140,160,180,200,250,300]*[25,35,50,70,90,110,130,160,200,300]','Reco p\_\{T\}(leading jet) [GeV]','Gen p\_\{T\}(leading jet) [GeV]'],
    'm3Lmet_gen:m3Lmet' : ['[50,70,90,120,160,200,280,360,450,550,650,800,1500,3000]*[50,60,70,80,90,100,120,140,160,180,200,240,280,320,360,400,450,500,550,600,650,700,800,1000,1500,2000,3000]','Reco M\_\{WZ\} [GeV]','Gen M\_\{WZ\} [GeV]']
    }
...
for iShape, iPack in pairs.items():
    ...
    print('echo \"{iShape}, range {iRange}, count {count}\"'.format(iShape=iShape,iRange=iRange,count=count))
    ...
    if count==0:
        print('rm -r {baseoutputdir}incl_fitWZonly_Zpt/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}incl_fitWZonly/ {baseoutputdir}incl_fitWZonly_Zpt/'.format(baseoutputdir=baseoutputdir))
        
        print('rm -r {baseoutputdir}eee_fitWZonly_Zpt/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}eee_fitWZonly/ {baseoutputdir}eee_fitWZonly_Zpt/'.format(baseoutputdir=baseoutputdir))
        
        print('rm -r {baseoutputdir}eem_fitWZonly_Zpt/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}eem_fitWZonly/ {baseoutputdir}eem_fitWZonly_Zpt/'.format(baseoutputdir=baseoutputdir))
        
        print('rm -r {baseoutputdir}mme_fitWZonly_Zpt/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}mme_fitWZonly/ {baseoutputdir}mme_fitWZonly_Zpt/'.format(baseoutputdir=baseoutputdir))
        
        print('rm -r {baseoutputdir}mmm_fitWZonly_Zpt/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}mmm_fitWZonly/ {baseoutputdir}mmm_fitWZonly_Zpt/'.format(baseoutputdir=baseoutputdir))

    elif count==1:
        print('rm -r {baseoutputdir}incl_fitWZonly_LeadJetPt/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}incl_fitWZonly/ {baseoutputdir}incl_fitWZonly_LeadJetPt/'.format(baseoutputdir=baseoutputdir))

        print('rm -r {baseoutputdir}eee_fitWZonly_LeadJetPt/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}eee_fitWZonly/ {baseoutputdir}eee_fitWZonly_LeadJetPt/'.format(baseoutputdir=baseoutputdir))

        print('rm -r {baseoutputdir}eem_fitWZonly_LeadJetPt/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}eem_fitWZonly/ {baseoutputdir}eem_fitWZonly_LeadJetPt/'.format(baseoutputdir=baseoutputdir))

        print('rm -r {baseoutputdir}mme_fitWZonly_LeadJetPt/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}mme_fitWZonly/ {baseoutputdir}mme_fitWZonly_LeadJetPt/'.format(baseoutputdir=baseoutputdir))

        print('rm -r {baseoutputdir}mmm_fitWZonly_LeadJetPt/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}mmm_fitWZonly/ {baseoutputdir}mmm_fitWZonly_LeadJetPt/'.format(baseoutputdir=baseoutputdir))

    elif count==2:
        print('rm -r {baseoutputdir}incl_fitWZonly_MWZ/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}incl_fitWZonly/ {baseoutputdir}incl_fitWZonly_MWZ/'.format(baseoutputdir=baseoutputdir))

        print('rm -r {baseoutputdir}eee_fitWZonly_MWZ/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}eee_fitWZonly/ {baseoutputdir}eee_fitWZonly_MWZ/'.format(baseoutputdir=baseoutputdir))

        print('rm -r {baseoutputdir}eem_fitWZonly_MWZ/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}eem_fitWZonly/ {baseoutputdir}eem_fitWZonly_MWZ/'.format(baseoutputdir=baseoutputdir))

        print('rm -r {baseoutputdir}mme_fitWZonly_MWZ/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}mme_fitWZonly/ {baseoutputdir}mme_fitWZonly_MWZ/'.format(baseoutputdir=baseoutputdir))

        print('rm -r {baseoutputdir}mmm_fitWZonly_MWZ/'.format(baseoutputdir=baseoutputdir))
        print('mv {baseoutputdir}mmm_fitWZonly/ {baseoutputdir}mmm_fitWZonly_MWZ/'.format(baseoutputdir=baseoutputdir))
