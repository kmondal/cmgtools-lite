...
def cncXsecComputer(table_yields, sigLabel):
    ...
    print("Signal yield: {s}".format(s=signal_yield))
    print("Signal init: {s}".format(s=signal_init))
    print("Scale: {s}".format(s=scale))
...
def plrXsecComputer(table_yields, sigLabel):
    print("Profile likelihood ratio not yet implemented, please wait for a few days")
